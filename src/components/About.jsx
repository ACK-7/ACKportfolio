    ...
    <section id="about" className="py-20">
      <div className="w-[90%] mx-auto px-4">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center text-2xl">
            <motion.div variants={fadeIn} custom={1} className="relative">
              <div className="relative w-full aspect-square max-w-md mx-auto">
                <div className=" inset-0 rounded-2xl overflow-hidden h-[600px] w-[500px]">
                  <img
                    src={cris}
            ...
            <motion.div variants={fadeIn} custom={2}>
              <h3 className="text-2xl font-bold mb-4">Software Engineer & UI/UX Enthusiast</h3>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8 text-[20px]">
                <div>
                  <h4 className="font-semibold mb-2">Name:</h4>
                  <p className="text-gray-300">Asiima Crisen</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Email:</h4>
                  <p className="text-gray-300">asiimac3@gmail.com</p>
                </div>
                <div>
