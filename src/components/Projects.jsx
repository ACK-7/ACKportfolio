...
const projects = [
  ...
  },
  {
    ...
    description: "A RESTful API for a social media platform with authentication, user profiles, and post management.",
    image: "https://via.placeholder.com/800x600",
  ...
  },
  {
    ...
    description:
      "A custom CMS for managing website content with a user-friendly interface and role-based access control.",
    image: "https://via.placeholder.com/800x600",
